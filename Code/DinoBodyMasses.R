...
DinoBodyMasses <- read.table("https://raw.githubusercontent.com/bethany-j-allen/sampling_bias_workshop/master/Data/DinoBodyMasses.txt?token=ABZPFHWSAKOG34FVMSU6YPK6VGKMQ", header = TRUE)
